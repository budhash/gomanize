...
- [ ] (F-0010) [P2] [todo] Structured parser QA: construct-coverage + invariants (find systematic parsing bugs) @shadow
  ...
  - [ ] (T-0039) [P2] [doing] Tier 2: parser invariant/property tests (schwa-kept=>vowel; independent-vowel=>own unit; matra != independent; nuclei count)
  - [ ] (T-0043) [P2] [todo] Corpus-diff transition matrix (rules-only; exact + minCER + variant-drift; stratified by dataset/split/construct/mode; lexical/acronym tagged)
